...
import model.core.Observable;

public class WaterEnvironnement implements Observable {
    ...
    public WaterEnvironnement(int size, int nbFish, int nbShark) throws NumberOfAgentsExceedSizeException {
        super();
        try {
    ...
    public void doIt() {
        ...
        Collections.shuffle(WaterEnvironnement.this.agents);
